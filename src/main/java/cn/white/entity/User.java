...
public class User {
	...
	private Timestamp cn_user_last_login;
    ...
    public Timestamp getCn_user_last_login() {
        return cn_user_last_login;
    }

    public void setCn_user_last_login(Timestamp cn_user_last_login) {
        this.cn_user_last_login = cn_user_last_login;
    }
    ...
    public String toString() {
        return "User{" +
                ...
                ", cn_user_last_login=" + cn_user_last_login +
                '}';
    }
}
